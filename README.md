...
> Auto-Text-Effect is a website built with HTML, SCSS, and TypeScript, utilizing linters to overcome code errors and maintain clean code. For more information, check out the live demo.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Auto-Text-Effect/src/)
